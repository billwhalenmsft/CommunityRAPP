        ...
        self.metadata = {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "agent_name": {
                        "type": "string",
                        "description": "Name of the RAPP agent to transpile (e.g., 'CarrierCaseTriageOrchestrator')"
                    },
                    "agent_file": {
                        "type": "string",
                    ...
                    "pattern": {
                        "type": "string",
                        "description": "Pattern to match agent names for batch_transpile (e.g., 'zurnelkay')"
                    },
                    "agent_list": {
                        "type": "array",
                        "items": {"type": "string"},
...
"""
    ...
    def _configure_deployment(self, **kwargs) -> str:
        ...
        return json.dumps({
            ...
            "next_steps": [
                ...
                "Example: action='deploy', agent_name='zurnelkay_drains_ci_agent'"
            ]
        }, indent=2)
    ...
    def _deploy_solution(self, **kwargs) -> str:
        ...
        if not solution_name:
            ...
            if kwargs.get("predefined") == "zurnelkay":
                return self._deploy_zurnelkay_solution(**kwargs)
            ...
            return json.dumps({
                ...
                "alternatives": {
                    "predefined_solutions": [
                        "Use predefined='zurnelkay' for Zurn Elkay CI solution"
                    ],
        ...
        try:
            ...
            for agent_name in solution["agents"]:
                try:
                    ...
                    solution_prefix = kwargs.get("name_prefix", "ZE")  # ZE = Zurn Elkay
                    ...
                    base_name = base_name.replace("Zurnelkay ", "")
    ...
    def _deploy_zurnelkay_solution(self, **kwargs) -> str:
        """
        Deploy the predefined Zurn Elkay Competitive Intelligence solution.
        
        This is a convenience method for the complete Zurn Elkay CI system:
        ...
        """
        # Define the Zurn Elkay solution
        zurnelkay_agents = [
            "zurnelkay_ci_orchestrator_agent",
            "zurnelkay_drains_ci_agent",
            "zurnelkay_drinking_water_ci_agent",
            "zurnelkay_sinks_ci_agent",
            "zurnelkay_commercial_brass_ci_agent",
            "zurnelkay_wilkins_ci_agent",
            "zurnelkay_crossbu_synthesizer_agent"
        ]
        
        # First, create/update the solution definition
        solution_result = json.loads(self._create_solution_definition(
            solution_name="zurnelkay_competitive_intelligence",
            display_name="Zurn Elkay Competitive Intelligence",
            description="Multi-agent competitive intelligence system for Zurn Elkay with orchestrated BU-specific agents and cross-BU synthesis capabilities.",
            publisher="RAPP",
            version=kwargs.get("version", "1.0.0"),
            agents=zurnelkay_agents
        ))
        ...
        if missing_agents:
            return json.dumps({
                ...
                "transpiled_agents": [a for a in zurnelkay_agents if a not in missing_agents],
                "next_steps": [
                    "Run batch_transpile for missing agents:",
                    f"action='batch_transpile', agent_list={missing_agents}",
                    "Then run: action='deploy_solution', predefined='zurnelkay'"
                ]
            }, indent=2)
        
        # Deploy the solution
        return self._deploy_solution(solution_name="zurnelkay_competitive_intelligence", **kwargs)